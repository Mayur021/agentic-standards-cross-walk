...
**Status:** v1 RFC — community contribution call OPEN

---

## What this is

A public RFC artifact that:
...
4. Identifies **gap-to-contribute slots** across Q3/Q4 2026 and 2027;
...
|---|---|---|
| [RFC.md](RFC.md) | **Primary artifact** — the public RFC with full substrate inventory + worked examples + contribution call | Anyone contributing to or citing standards across the 12 families |
