...
- Mayur Agnihotri ([@Mayur021](https://github.com/Mayur021) on GitHub) — open Issues, PRs, or Discussions on this repo
- Joint anchor for CSA NHI 6-property: Mallikarjunarao Sunke (please direct CSA NHI 6-property cross-walks to both names)
- Project leads of each named substrate (per substrate row) for substrate-specific corrections.
